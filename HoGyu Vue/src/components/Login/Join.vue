<template>
    <div class="whole" style="background-color: #ededed; width: auto; height: 100vh;">
        <!-- <h1>회원 가입</h1>
        <h3>이름 : </h3>
        ...
        <router-link to="/" @click="createUser">회원가입</router-link> -->
        <div class="loginbox">
            ...
            <form style="height: 70%;">
                ...
                <fieldset>
                    ...
                    <input type="text" id="loginid" v-model="user.name" placeholder="아이디를 입력해 주세요">
                    <label for="loginid">아이디</label>
                    <input type="text" id="loginid" v-model="user.id" placeholder="아이디를 입력해 주세요">
                    <label for="loginpw">비밀번호</label>
                    <input type="password" id="loginpw"  v-model="user.password" placeholder="비밀번호를 입력해 주세요" >
                    <label for="loginid">전화번호</label>
                    <input type="text" id="loginid" v-model="user.phoneNum" placeholder="전화번호를 입력해 주세요" @keyup.enter="createUser">
                
                    <!--데이터를 서버로 전송-->
                    <router-link to="/" @click="createUser">
                        <!-- <button class="log" >회원가입</button> -->
                        <a title="Button border lightblue" class="button btnFloat btnLightBlue" style="margin: 3% 35%; background-color: #ededed;">회원가입</a>
                    </router-link>
                </fieldset>
            </form>
        </div>
...
.log{
    ...
    margin: 3% auto; /* 블록요소가 부모 영역에서 가운데 오기 */
    border: none;
